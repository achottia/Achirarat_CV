  ...
  <ul style="list-style-type: none; padding-left: 0;">
    <li style="margin-bottom: 15px;">
      <div style="display: flex; justify-content: space-between;">
        <div>
          <b>มหาวิทยาลัยเทคนิคดาร์มชตัดท์</b> ดาร์มชตัดท์, เฮสเซิน, เยอรมนี<br> 
...
const thResearchPageData = {
  ...
  content: `
    <div class='research_content'>
        ...
        <b>บทคัดย่อ</b> : การสื่อสารระดับโมเลกุล (MC) เป็นสาขาที่กำลังเติบโตซึ่งใช้โมเลกุลเป็นตัวพาข้อมูล มีการประยุกต์ใช้ในด้านการดูแลสุขภาพ การตรวจสอบสิ่งแวดล้อม และเทคโนโลยีชีวภาพ ทิศทางที่น่าสนใจคือ MC ที่ได้แรงบันดาลใจจากการดมกลิ่น (OMC) ซึ่งเลียนแบบการดมกลิ่นทางชีววิทยาโดยใช้เซ็นเซอร์แบบไขว้ที่จำนวนชนิดโมเลกุลมากกว่าจำนวนตัวรับ สิ่งนี้ช่วยให้สามารถส่งข้อมูลได้อย่างมีประสิทธิภาพโดยใช้ส่วนผสมของโมเลกุล แต่ยังนำมาซึ่งความท้าทาย เช่น การเลือกตัวอักษรส่วนผสมที่เหมาะสม ในขณะที่งานก่อนหน้าใช้เมตริกความแตกต่างที่ซับซ้อน วิทยานิพนธ์นี้เสนอวิธีที่ง่ายกว่าโดยใช้ระยะทางแบบยุคลิด มีการสำรวจสองรูปแบบ: แนวทาง Max-Min เพื่อเพิ่มการแยกส่วนผสมให้สูงสุด และวิธีแบบแรงผลัก (Repulsion-Based) ที่ได้แรงบันดาลใจจากปฏิสัมพันธ์ของอนุภาคตามธรรมชาติ นอกจากนี้ยังมีการแนะนำข้อความลำดับความสำคัญสำหรับข้อมูลสำคัญที่มีอัตราข้อผิดพลาดต่ำกว่า สำหรับการเลือกเซ็นเซอร์ มีการประเมิน Fast Binary Search และ Condition Number Minimization ซึ่งมีประสิทธิภาพดีกว่าการเลือกแบบสุ่มทั้งในด้านความแม่นยำและประสิทธิภาพด้านต้นทุน ผลการค้นพบสนับสนุนการพัฒนาระบบการสื่อสารชีวภาพที่แข็งแกร่งในอนาคต โดยงานที่กำลังดำเนินการมุ่งเน้นไปที่การหาค่าเหมาะสมที่ขยายได้และการออกแบบตัวรับ
        <h2 class='title'> วิทยานิพนธ์ปริญญาตรี </h2>
        <b>เครื่องบันทึกข้อมูลยานยนต์</b>, <i> ที่ปรึกษา </i> ผศ.ดร.ศุภชัย วรโพธิ์พิสุทธิ์<br>
        <br>
        <div style="display: flex; gap: 5px; flex-wrap: wrap;">
...
const thJobsPageData = {
  ...
  items: [
    ...
    },
    {
      ...
      company: "อัลสต็อม ทรานสปอร์เตชั่น ประเทศไทย",
    ...
    {
      title: `วิศวกรซอฟต์แวร์`,
      company: "โตโยต้า ซูโช เด็นโซ อีเล็คโทรนิคส์ ประเทศไทย (TDET)",
      ...
      achievements: ["วิเคราะห์ข้อกำหนดการทำงานของยานยนต์และพัฒนาซอฟต์แวร์สำหรับฟังก์ชันยานยนต์โดยใช้ MATLAB และ SIMULINK", 
        ...
        "อาจารย์ผู้สอนด้านการพัฒนาซอฟต์แวร์ การใช้งาน MATLAB library และกระบวนการพัฒนาซอฟต์แวร์สำหรับสมาชิกที่เพิ่งจบใหม่"],
    },
  ],
};
// ---------- Hobby data
